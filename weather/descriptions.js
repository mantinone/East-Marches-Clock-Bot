module.exports = {
  "prec-fog": {
    name: "Fog:",
    text: "Whether in the form of a low-lying cloud or a mist rising from the ground, fog obscures all sight, including darkvision, beyond 5 feet. Creatures 5 feet away have concealment (attacks by or against them have a 20% miss chance)."
  },
  "prec-hail": {
    name: "Hail:",
    text: " The sound of falling hail imposes a -4 penalty on Listen checks. Sometimes hail can become large enough to deal 1 point of lethal damage (per storm) to anything in the open.
      A day of hail leaves 1d6 inches of loose ice on the ground. It costs 2 squares of movement to enter a hail-covered square."
  },
  "prec-heavy_snow": {
    name: "Heavy Snow:",
    text: " Heavy snow reduces visibility by half, imposing a -4 penalty on Spot and Search checks. All sight, including darkvision, is obscured beyond 5 feet. Creatures 5 feet away have concealment (attacks by or against them have a 20% miss chance). It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
  ...
  "prec-rain": {
    name: "Rain:",
    text: " Rain reduces visibility by half, imposing a -4 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
  ...
  "prec-sleet": {
    name: "Sleet:",
    text: " Essentially frozen rain, sleet reduces visibility by half, imposing a -4 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
  ...
  "prec-snow": {
    name: "Snow:",
    text: " Snow reduces visibility by half, imposing a -4 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
      A day of snowfall leaves 1d6 inches of snow on the ground. It costs 2 squares of movement to enter a snow-covered square."
    },
  "temp-cold": {
    name: "Cold:",
    text: " An unprotected character in cold weather (below 40°F) must make a Fortitude save each hour (DC 15, + 1 per previous check) or take 1d6 points of nonlethal damage.
  ...
  "temp-extreme_heat": {
    ...
    text: " Extreme heat (air temperature over 140°F, fire, boiling water, lava) deals lethal damage. Breathing air in these temperatures deals 1d6 points of damage per minute (no save). In addition, a character must make a Fortitude save every 5 minutes (DC 15, + 1 per previous check) or take 1d4 points of nonlethal damage. In addition, those wearing metal armor or coming into contact with very hot metal are affected as if by a <iheat metal</i spell.
      ...
      Nonlethal damage from heat exposure cannot be recovered until the character gets cooled off (reaches shade, survives until nightfall, gets doused in water, is targeted by <iendure elements</i, and so forth). Once rendered unconscious through the accumulation of nonlethal damage, the character begins to take lethal damage at the same rate."
    },
  "temp-severe_cold": {
    name: "Severe Cold:",
    text: " In conditions of severe cold or exposure (below 0°F), an unprotected character must make a Fortitude save once every 10 minutes (DC 15, +1 per previous check), taking 1d6 points of nonlethal damage on each failed save.
      A character who has the Survival skill may receive a bonus on her saving throw and may be able to apply this bonus to other characters as well. Characters wearing winter clothing only need check once per hour for cold and exposure damage.
      A character who takes any nonlethal damage from cold or exposure is beset by frostbite or hypothermia (treat her as fatigued). These penalties end when the character recovers the nonlethal damage she took from the cold and exposure.
      Nonlethal damage from cold or exposure cannot be recovered until the character gets out of the cold and warms up again. Once a character is rendered unconscious through the accumulation of nonlethal damage, the cold and exposure begins to deal lethal damage at the same rate."
    },
  "temp-severe_heat": {
    name: "Severe Heat:",
    text: " In severe heat (above 110°F), a character must make a Fortitude save once every 10 minutes (DC 15, + 1 for each previous check) or take 1d4 points of nonlethal damage.
      Characters wearing heavy clothing or armor of any sort take a -4 penalty on their saves. A character with the Survival skill may receive a bonus on her saving throw and may be able to apply this bonus to other characters as well.
      A character who takes any nonlethal damage from heat exposure now suffers from heatstroke and is fatigued. These penalties end when the character recovers the nonlethal damage she took from the heat.
      Nonlethal damage from heat exposure cannot be recovered until the character gets cooled off (reaches shade, survives until nightfall, gets doused in water, is targeted by <iendure elements</i, and so forth). Once rendered unconscious through the accumulation of nonlethal damage, the character begins to take lethal damage at the same rate."
  },
  "temp-very_hot": {
    name: "Very Hot:",
    text: " A character in very hot conditions (above 90°F) must make a Fortitude saving throw each hour (DC 15, + 1 for each previous check) or take 1d4 points of nonlethal damage.
      Characters wearing heavy clothing or armor of any sort take a -4 penalty on their saves. A character with the Survival skill may receive a bonus on her saving throw and may be able to apply this bonus to other characters as well.
      A character who takes any nonlethal damage from heat exposure now suffers from heatstroke and is fatigued. These penalties end when the character recovers the nonlethal damage she took from the heat.
      Nonlethal damage from heat exposure cannot be recovered until the character gets cooled off (reaches shade, survives until nightfall, gets doused in water, is targeted by <iendure elements</i, and so forth). Once rendered unconscious through the accumulation of nonlethal damage, the character begins to take lethal damage at the same rate."
  },
  "wind-hurricane": {
    name: "Hurricane:",
    text: " Listen checks are impossible, as all that characters can hear is the roaring of the wind. Ranged weapon attacks are impossible, except for those using siege weapons, which suffer a -8 penalty on attack rolls.
  ...
  "wind-light": {
    name: "Light Wind:",
    text: " A gentle breeze, having little or no game effect."
  },
  "wind-moderate": {
    name: "Moderate Wind:",
    text: " A steady wind with a 50% chance of extinguishing candles, torches, and similar unprotected flames."
  },
  "wind-severe": {
    name: "Severe Wind:",
    text: " Winds of this magnitude impose a -4 penalty on Listen checks and ranged weapon attacks. Severe wind automatically extinguishes candles, torches, and similar unprotected flames. It causes protected flames, such as those of lanterns, to dance wildly and has a 50% chance to extinguish these lights.
  ...
  "wind-strong": {
    name: "Strong Wind:",
    text: " Strong gusts of wind that impose a -2 penalty on Listen checks and ranged weapon attacks. Such gusts automatically extinguish candles, torches, and similar unprotected flames.
  ...
  "wind-tornado": {
    name: "Tornado (CR 10):",
    text: " While a tornado's rotational speed can be as great as 300 mph, the funnel itself moves forward at an average of 30 mph (roughly 250 feet per round).
  ...
  "wind-windstorm": {
    name: "Windstorm:",
    text: " Powerful enough to bring down branches if not whole trees, windstorms impose a -8 penalty on Listen checks due to the howling of the wind. Ranged weapon attacks are impossible, except for those using siege weapons, which suffer a -4 penalty on attack rolls.
  ...
  "desc-blizzard": {
    name: "Blizzard:",
    text: " The combination of high winds, heavy snow (typically 1d3 feet), and bitter cold make blizzards deadly for all who are unprepared for them.
  ...
  "desc-greater_duststorm": {
    name: "Greater Duststorm:",
    text: " Greater duststorms drive fine grains of sand in windstorm-force winds. The combined effects of dust and wind reduce visibility to zero, making Spot, Search, and Listen checks and all ranged weapon attacks impossible.
  ...
  "desc-hurricane": {
    name: "Hurricane:",
    text: " The combined effects of torrential precipitation and high wind reduce visibility to zero, making Spot, Search, and Listen checks and all ranged weapon attacks impossible.
      All flames are automatically extinguished.
      Hurricane-force winds often fell trees. Creatures must succeed on a DC 20 Fort save or be blown away (Medium or smaller creatures; knocked prone and rolled 1d4 x 10 feet, taking 1d4 points of nonlethal damage per 10 feet), knocked down (Large; prone), or checked (Huge; unable to move forward against the force of the wind).
      Airborne creatures are instead blown back 2d6 x 10 feet and dealt 2d6 points of nonlethal damage due to battering and buffeting (Large or smaller creatures), blown back 1d6 x 10 feet (Huge), or blown back 1d6 x 5 feet (Gargantuan).
      In addition, hurricanes are accompanied by floods. Most adventuring activity is impossible under such conditions."
  },
  "desc-severe_thunderstorm": {
  ...
  "desc-snowstorm": {
    name: "Snowstorm:",
    text: " The combined effects of precipitation and wind reduce visibility by three quarters, imposing a -8 penalty on Spot, Search, and Listen checks. Snowstorms make ranged weapon attacks impossible, except for those using siege weapons, which suffer a -4 penalty on attack rolls.
  ...
  "desc-thunderstorm": {
    name: "Thunderstorm:",
    text: " The combined effects of precipitation and wind reduce visibility by three quarters, imposing a -8 penalty on Spot, Search, and Listen checks. Thunderstorms make ranged weapon attacks impossible, except for those using siege weapons, which suffer a -4 penalty on attack rolls.
  ...
  "desc-aberrant_sky": {
    name: "Aberrant Sky:",
    text: " An aberrant sky appears twisted and wrong, filled with an unearthly shade of light and clouds of impossible and monstrous shapes. Creatures which gaze upon an aberrant sky must succeed on a DC 18 Will save or be driven insane, suffering the effects of <iconfusion</i for 1d6 hours. Roll on the following table at the beginning of each affected creature's turn each round to see what the creature does in that round.
      <table<tbody<tr<thd%</th<thBehavior</th</tr<tr<td01-10</td<tdDo nothing but babble incoherently</td</tr<tr<td11-20</td<tdAct normally</td</tr<tr<td21-50</td<tdDo nothing but babble incoherently</td</tr<tr<td51-70</td<tdFlee in a random direction</td</tr<tr<td71-00</td<tdAttack the nearest creature</td</tr</tbody</table"
  },
  "desc-acid_rain": {
    name: "Acid Rain:",
    text: " Acid rain deals 1d6 points of acid damage (DC 15 Reflex save negates) each minute to anyone caught out in the open without shelter.
  ...
  "desc-animus_blizzard": {
    name: "Animus Blizzard:",
    text: " The combination of high winds, heavy snow (typically 1d3 feet), and bitter cold make blizzards deadly for all who are unprepared for them. Further, animus blizzards are infused with negative energy, and any creature which perishes in one becomes a wight 1d4 rounds later.
      Blizzards reduce visibility to zero, making Spot, Search, and Listen checks and all ranged weapon attacks impossible. All sight, including darkvision, is obscured beyond 5 feet. Creatures 5 feet away have concealment (attacks by or against them have a 20% miss chance).
      Blizzards automatically extinguish candles, torches, and similar unprotected flames. They have a 75% chance to extinguish protected flames, such as those of lanterns.
      Creatures must succeed on a DC 18 Fort save or be blown away (Small or smaller creatures; knocked prone and rolled 1d4 x 10 feet, taking 1d4 points of nonlethal damage per 10 feet), knocked down (Medium; prone), or checked (Large or Huge; unable to move forward against the force of the wind).
      Airborne creatures are instead blown back 2d6 x 10 feet and dealt 2d6 points of nonlethal damage due to battering and buffeting (Medium or smaller creatures), blown back 1d6 x 10 feet (Large), or blown back 1d6 x 5 feet (Huge or Gargantuan).
  ...
  "desc-arcane_tempest": {
    name: "Arcane Tempest:",
    text: " An arcane tempest appears to be a normal thunderstorm, but possesses a powerful magical aura. All spells and spell-like abilities used within the tempest are empowered as if affected by the Empower Spell feat, although a spell so affected doesn't require a higher-level spell slot or additional casting time. Spells and spell-like abilities that are already empowered are unaffected.
  ...
  "desc-blacksleet": {
    name: "Blacksleet:",
    text: " Blacksleet is frozen rain imbued with negative energy. Creatures caught out in the open without shelter must succeed on a DC 15 Fort save once every hour or gain 1 negative level.
  ...
  "desc-celestial_clarity": {
    name: "Celestial Clarity:",
    text: " The sky is a perfect azure blue, colors seem more vibrant, and details appear sharper. Celestial clarity grants a +4 bonus to Spot, Search, Listen, and Sense Motive checks. It also negates any fear or confusion effects."
  },
  "desc-clockwork_clouds": {
    name: "Clockwork Clouds:",
    text: " Clouds shaped like gears spin slowly overhead, sometimes interlocking with other clouds to form complex clockworks."
  },
  "desc-crimson_fog": {
    name: "Crimson Fog:",
    text: " These dread fogs drift from distant and bloody battlefields, bringing with them terrible visions of death and madness. Fog obscures all sight, including darkvision, beyond 5 feet. Creatures 5 feet away have concealment (attacks by or against them have a 20% miss chance). In addition, creatures within the fog must succeed on a DC 15 Will save once every minute or act randomly.
    <table<tbody<tr<thd%</th<thBehavior</th</tr<tr<td01-50</td<tdAct normally</td</tr<tr<td51-70</td<tdFlee in a random direction</td</tr<tr<td71-00</td<tdAttack the nearest creature</td</tr</tbody</table"
  },
  "desc-dire_hail": {
    name: "Dire Hail:",
    text: " Dire hail is at least an inch in size, and covered with sharp spikes of ice. It deals 1d6 points of damage (DC 15 Reflex save negates) each minute to anyone caught out in the open without shelter. The sound of falling hail imposes a -4 penalty on Listen checks.
      A day of hail leaves 1d6 inches of loose ice on the ground. It costs 2 squares of movement to enter a hail-covered square."
  },
  "desc-draconic_clouds": {
    name: "Draconic Clouds:",
    text: " Clouds shaped like dragons and winged wyrms twist through the sky, sometimes colliding and tearing through each other."
  },
  "desc-dragons_breath": {
    name: "Dragon's Breath:",
    text: " Gusts of hot air blow out of the east, accompanied by wisps of flame. Dragon's breath has a 50% chance of igniting candles, torches, tinder, loose paper, and similar flammable objects."
  },
  "desc-empyrean_sky": {
    name: "Empyrean Sky:",
    text: " Golden or rose colored light fills the sky, and heroes and heroic deeds are granted divine favor. Good characters beneath an empyrean sky gain a +2 morale bonus to attack rolls and a +4 morale bonus to skill checks, and neutral characters gain a +1 morale bonus to attack rolls and a +2 morale bonus to skill checks."
  },
  "desc-ethereal_fog": {
    name: "Ethereal Fog:",
    text: " Ethereal fog is a shimmering mist which manifests suddenly and out of thin air. It obscures all sight, including darkvision, beyond 5 feet. Creatures 5 feet away have concealment (attacks by or against them have a 20% miss chance). In addition, creatures taking a movement action within the fog must succeed on a DC 15 Will save or be teleported to a different random location within the fog."
  },
  "desc-expeditious_tailwind": {
    name: "Expeditious Tailwind:",
    text: " An expeditious tailwind is a fey zephyr which follows creatures, pushing them along more swiftly. Creatures gain an enhancement bonus of 30 feet to their walking or flying speed.
      Expeditious wind has a 50% chance of extinguishing candles, torches, and similar unprotected flames."
  },
  "desc-firestorm": {
    name: "Firestorm:",
    text: " A firestorm manifests as a swirling cloud of smoke which suddenly explodes with flashes of fire and sheets of falling flame. Firestorms deal 1d6 points of fire damage (DC 15 Reflex save negates) each round to anyone caught out in the open without shelter, but rarely last more than a few minutes.
  ...
  "desc-hallucinatory_storm": {
    name: "Hallucinatory Storm:",
    text: " Dark clouds shot through with lightning rage overhead, and rumbling thunder and howling winds fill the air. The noise imposes a -4 penalty on Listen checks, but the storm has no other effect."
  },
  "desc-immuring_sleet": {
    name: "Immuring Sleet:",
    text: " Immuring sleet falls as rain, but freezes into masses of ice the instant it touches an object or creature. Creatures caught out in the open without shelter must attempt a DC 15 Fort save once every hour.
  ...
  "desc-incendiary_clouds": {
    name: "Incendiary Clouds:",
    text: " Clouds of roiling smoke shot through with hot embers drift overhead, casting a fiery glow. Airborne creatures flying into an incendiary cloud cause it to ignite, dealing 4d6 points of fire damage (DC 18 Reflex save negates)."
  },
  "desc-incorporeal_wind": {
    name: "Incorporeal Wind:",
    text: " Incorporeal wind passes through physical objects and barriers, such as clothing, armor, walls, and solid earth and stone. It negates any benefit of winter clothing against cold and exposure effects, but also negates any penalty for heavy clothing or armor against heat. Incorporeal wind is blocked only by <image armor</i, <iwall of force</i, and similar force effects."
  },
  "desc-leaden_snow": {
    name: "Leaden Snow:",
    text: " Leaden snow appears to be normal snow, but is far heavier. Objects beneath leaden snow take 1d6 points of damage per inch of snowfall. Creatures beneath leaden snow take 1d6 points of nonlethal damage per minute. If a creature falls unconscious beneath leaden show, it takes 1d6 points of lethal damage (DC 15 Constitution check negates) each minute thereafter until freed or dead.
  ...
  "desc-leaden_snowstorm": {
    name: "Leaden Snowstorm:",
    text: " Leaden snow appears to be normal snow, but is far heavier. Objects beneath leaden snow take 1d6 points of damage per inch of snowfall. Creatures beneath leaden snow take 1d6 points of nonlethal damage per minute. If a creature falls unconscious beneath leaden show, it takes 1d6 points of lethal damage (DC 15 Constitution check negates) each minute thereafter until freed or dead.
  ...
  "desc-lethe_snow": {
    name: "Lethe Snow:",
    text: " Lethe snow is imbued with enchantment magic, and is often accompanied by a faint tinkling sound as it falls. Creatures caught out in the open without shelter must succeed on a DC 15 Fort save once every hour or fall asleep for 1 hour.
  ...
  "desc-levitant_ice": {
    name: "Levitant Ice:",
    text: " Levitant ice occurs when strange alchemical essences become mixed into cold clouds. Unsecured creatures and objects lose weight as ice accumulates upon them, and after one minute begin floating upwards at the rate of twenty feet per round. The effect ends gradually, as the levitant ice melts.
      Sleet reduces visibility by half, imposing a -4 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
      Sleet automatically extinguishes candles, torches, and similar unprotected flames. It causes protected flames, such as those of lanterns, to dance wildly and has a 75% chance to extinguish these lights."
  },
  "desc-luminous_clouds": {
    name: "Luminous Clouds:",
    text: " Luminous clouds cast light as bright as full daylight, even at night. Creatures which suffer penalties or are damaged or destroyed by daylight are similarly affected by luminous cloudlight. Magical darkness of any level counters luminous cloudlight."
  },
  "desc-phantom_snow": {
    name: "Phantom Snow:",
    text: " Phantom snow was named by rogues and thieves, who take particular advantage of it. Anyone moving upon it does so silently (+4 bonus to Move Silently checks), and leaves neither track nor trace of their passage.
      Snow reduces visibility by half, imposing a -4 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
      A day of snowfall leaves 1d6 inches of snow on the ground. It costs 2 squares of movement to enter a snow-covered square."
  },
  "desc-prismatic_rain": {
    name: "Prismatic Rain:",
    text: " Prismatic rain falls in brilliant, rainbow-hued drops. Prismatic rain reduces visibility by three quarters, imposing a -8 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
      Rain automatically extinguishes candles, torches, and similar unprotected flames. It causes protected flames, such as those of lanterns, to dance wildly and has a 50% chance to extinguish these lights."
  },
  "desc-psychic_calm": {
    name: "Psychic Calm:",
    text: " A supernatural calm settles over the land, stopping raging creatures from fighting and joyous ones from reveling. Creatures cannot take violent actions (although they can defend themselves) or do anything destructive. Psychic calm negates any morale bonuses granted by spells such as <ibless</i, <igood hope</i, and <irage</i, as well as a bard's ability to inspire courage or a barbarian's rage ability. It also negates any fear or confusion effects."
  },
  "desc-reverse_rain": {
    name: "Reverse Rain:",
    text: " Reverse rain rises in sheets from pools, lakes, streams, rivers, and other open water into the sky.
      Rain reduces visibility by half, imposing a -4 penalty on Spot and Search checks. It also imposes a -4 penalty on Listen checks and ranged weapon attacks.
      Rain automatically extinguishes candles, torches, and similar unprotected flames. It causes protected flames, such as those of lanterns, to dance wildly and has a 50% chance to extinguish these lights."
  },
  "desc-rogue_zephyr": {
    name: "Rogue Zephyr:",
    text: " Rogue zephyrs are gentle but magical breezes which undo simple (those of DC 20 or less) knots, locks, bolts, manacles, shackles, and similar impediments.
      A rogue zephyr has a 50% chance of extinguishing candles, torches, and similar unprotected flames."
  },
  "desc-skyquake": {
    name: "Skyquake:",
    text: " Violent shockwaves suddenly tear through the sky, causing it to crack and clouds to be torn apart and scattered. Creatures must make a DC 15 Fort save or be deafened for 1 hour from the thunderous noise. Airborne creatures must make an additional DC 15 Fort save or take 2d6 points of nonlethal damage due to battering and buffeting."
  },
  "desc-solid_fog": {
    name: "Solid Fog:",
    text: " Fog obscures all sight, including darkvision, beyond 5 feet. Creatures 5 feet away have concealment (attacks by or against them have a 20% miss chance). In addition, solid fog is so thick that any creature attempting to move through it progresses at a speed of 5 feet, regardless of its normal speed. A creature can't take a 5-foot step while in solid fog.
  ...
  "desc-spiderweb_clouds": {
    name: "Spiderweb Clouds:",
    text: " Tangled strands of cloud fill the sky like spiderwebs. Airborne creatures which fly into a spiderweb cloud become entangled (DC 15 Reflex save negates). An entangled creature moves at half speed, cannot run or charge, and takes a -2 penalty on all attack rolls and a -4 penalty to Dexterity."
  },
  "desc-starfall_hail": {
    name: "Starfall Hail:",
    text: " Stars fall from the sky, plummeting to the ground as frozen pellets of soft, fading light. After a starfall hail, the night sky remains totally dark until the next evening.
  ...
  "desc-temporal_wind": {
    name: "Temporal Wind:",
    text: " Temporal winds are rarely severe in any physical dimension, but can easily blow creatures through the dimension of time. Creatures must succeed on a DC 15 Will save or be blown 1d6 hours forward. The creature seems to disappear in a shimmer of silver light, then reappears later in exactly the same space (or closest unoccupied space), orientation, and condition as before. From the affected creature's point of view, no time has passed at all.
      Temporal wind has a 50% chance of extinguishing candles, torches, and similar unprotected flames."
  },
  "desc-thunder_hail": {
    name: "Thunder Hail:",
    text: " Thunder hail strikes the ground with deafening blasts of noise and ice shrapnel. It deals 1d6 points of damage (DC 15 Fort save negates) each minute to anyone caught out in the open without shelter. The sound of thunder hail makes Listen checks impossible.
      A day of hail leaves 1d6 inches of loose ice on the ground. It costs 2 squares of movement to enter a hail-covered square."
  },
  "desc-volant_mistral": {
    name: "Volant Mistral:",
    text: " While a volant mistral blows, an individual of at least fifth level (5 HD) can fly at a speed of 40 feet (or 30 feet if it wears medium or heavy armor, or if it carries a medium or heavy load). It can ascend at half speed and descend at double speed, and its maneuverability is good. Flying requires only as much concentration as walking, so the individual can attack or cast spells normally.
      A volant mistral has a 50% chance of extinguishing candles, torches, and similar unprotected flames."
  },
  "desc-whispering_wind": {
    name: "Whispering Wind:",
    text: " While a whispering wind blows, an individual of at least third level (3 HD) can send a message or sound on the wind to a designated location. The location must be familiar and within one mile. The message is delivered regardless of whether anyone is present to hear it.
